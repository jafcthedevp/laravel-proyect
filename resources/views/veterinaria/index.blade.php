        ...
        <div class="row hero-one-slider owl-carousel owl-theme">
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="hero-img">
                            <img src="https://via.placeholder.com/450x566" alt="img">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="we-provide">
                    <div class="we-provide-img">
                        <img src="https://via.placeholder.com/300x300" alt="we-provide-1">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="dog-walker two d-block">
                    ...
                    <img src="https://via.placeholder.com/636x721" class="w-100" alt="dog walker">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="healthy-product">
                    <div class="healthy-product-img">
                        <img src="https://via.placeholder.com/217x255" alt="food">
                        <ul class="star">
            ...
            <div class="col-lg-9">
                <div class="deal-of-the-week">
                    <div class="healthy-product-img">
                        ...
                        <img src="https://via.placeholder.com/293x258" alt="food">
                        <ul class="star">
                            <li><i class="fa-solid fa-star"></i></li>
                            <li><i class="fa-solid fa-star"></i></li>
                            <li><i class="fa-solid fa-star"></i></li>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="team-working">
                    <img src="https://via.placeholder.com/170x170" alt="team">
...
<section class="gap"> 
    <div class="container">
        <div class="dog-walker">
            <img src="https://via.placeholder.com/616x704" alt="dog walker">
            <img src="assets/img/line.png" class="line" alt="line">
            <img src="assets/img/dabal-foot.png" class="dabal-foot" alt="dabal-foot">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="blog-style">
                    <figure>
                        <img src="https://via.placeholder.com/416x264" alt="img">
                    </figure>
                    ...
                    <div class="blog-style-text">
                        ...
                        <div>
                            ...
                            <div class="d-flex align-items-center">
                                <img src="https://via.placeholder.com/50x50" alt="man">
    ...
    <div class="container">
        <div class="insta-img">
            ...
            <ul class="image-gallery">
              <li>
                <a href="https://via.placeholder.com/170x170" data-fancybox="gallery"><figure><img alt="girl" src="https://via.placeholder.com/170x170"></figure></a>
              </li>
              <li>
                <a href="https://via.placeholder.com/170x170" data-fancybox="gallery"><figure><img alt="girl" src="https://via.placeholder.com/170x170"></figure></a>
              </li>
